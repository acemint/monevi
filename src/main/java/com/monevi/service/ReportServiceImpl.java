...
public class ReportServiceImpl implements ReportService {
  ...
  @Override
  public Report addComment(ReportAddCommentRequest request) throws ApplicationException {
      /*
      TODO: Given a user id, find the username of the person. For now set commented by as the user id (MEDIUM)
      TODO: Validate that only Student with Leader Role and Supervisor can do this (LOW)
       */
